...
{		
    /* 栈使用情况 */
    TaskHandle_t xTaskStack;
    UBaseType_t freeSize;
...
//	ball.velY = -1.1;
    ...
    while (1)
    {
        ...
        /* 获取栈使用情况 */
//        xTaskStack = xTaskGetCurrentTaskHandle();
//        freeSize = uxTaskGetStackHighWaterMark(xTaskStack);
//        printf("FreeStack of Task %s : %d\n\r", pcTaskGetName(xTaskStack), freeSize);
