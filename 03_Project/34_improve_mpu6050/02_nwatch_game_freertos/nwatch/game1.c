...
{		
    ...
    /* 旋转编码器任务 */
    xTaskCreate(MPU6050_Task, "MPU6050_Task", 90, NULL, osPriorityNormal, NULL);
    xTaskCreate(InputTask, "InputTask", 60, NULL, osPriorityNormal, NULL);
...
//	ball.velY = -1.1;
    ...
    /* 挡球板任务 */
    xTaskCreate(platform_task, "platform_task", 90, NULL, osPriorityNormal, NULL);
